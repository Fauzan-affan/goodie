...
import { viewRule } from "appRedux/actions/Rules";
...
class ViewRule extends Component {
  ...
  render() {
    ...
    if (this.props.match.params.type === "basic") {
      ...
      // console.log(this.state.basicRule)
      ...
      content = [
        ...
        {
          key: "ruleStoreCollaboration",
          label: "Rule Store Collaboration",
          checked: this.state.basicRule.isRuleCollaboration == "yes" ? true : false,
          disableSwitch: true,
          type: "switch",
        },
        {
          ...
          type: this.state.basicRule.isRuleCollaboration == "yes" ? "text" : "",
        },
        {
