...
const mapStateToProps = ({auth, pointState, merchantState, commonState}) => {
    ...
    const {data, updateSuccess, updateFailed, updateData, createSuccess, createFailed,  createData} = pointState;
    return {authUser, data, updateSuccess, updateFailed, updateData, createSuccess, createFailed, createData, merchant, currency, logoPoint, listCurrency, listProvince,
        listCity,}
};
