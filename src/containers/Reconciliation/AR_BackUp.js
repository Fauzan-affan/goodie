...
class SearchReconciliationReceiveble_BackUp extends Component {
    ...
    fetchData = (filterAndSort, isDownload)=>{
        ...
        this.props.searchReconciliationReceiveble(credential);
    }
    ...
    render() {
        ...
        let columns = [
            {
                title: 'Merchant Name',
                dataIndex: 'merchantReceivable',
                label : 'Merchant Name',
                key: 'merchantReceivable',
        ...
        return(
            <div>
                ...
                <CSVLink
                    ...
                    filename={"Reconciliation Receiveble Report.csv"}
                    style={{display:'none'}}
                    ref={this.csvLink}
                >
                    Download
...
export default connect(mapStateToProps, {searchReconciliationReceiveble,
    // viewReconciliation,
    filterSortSearch, clearFilterSortSearch, resetStatus})(SearchReconciliationReceiveble_BackUp);
