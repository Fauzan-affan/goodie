...
class ChangePassword extends Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        if (nextProps.updateSuccess && !nextProps.updateFailed){
            this.setState({
                msgContent : 'Change password successfully',
                msgShow : true,
                msgType : 'success'
            })
        }else if (!nextProps.updateSuccess && nextProps.updateFailed){
            this.setState({
                msgContent : 'Change password failed',
                msgShow : true,
                msgType : 'danger'
            })
        }
...
const mapStateToProps = ({auth}) => {
    const {authUser,updateSuccess, updateFailed, alertMessage, showMessage} = auth;
    return {authUser, updateSuccess, updateFailed, alertMessage, showMessage}
};

export default connect(mapStateToProps, {
    changePassword})(WrappedChangePasswordForm);
